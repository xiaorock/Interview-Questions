...
interface BasicProps {
  ...
  listBasic: BasicProfileDataType;
}
...
@connect(
  ({
    ...
    listBasic,
    loading: loading.effects['listBasic/fetchBasic'],
  }),
)
...
> {
  componentDidMount() {
    ...
    dispatch({
      type: 'listBasic/fetchBasic',
    });
  }

  render() {
    const { listBasic, loading } = this.props;
    const { basicGoods, basicProgress } = listBasic;
